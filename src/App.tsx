...
const UI_TEXT: Record<Lang, Record<string, string>> = {
  en: {
    chooseLanguage: "Choose language", appTitle: "Driver Pay App V5.2.2", currentDay: "Current day", install: "Install", week: "Week", settings: "Settings", language: "Language",
  ...
  bg: {
    chooseLanguage: "Избери език", appTitle: "Driver Pay App V5.2.2", currentDay: "Текущ ден", install: "Инсталирай", week: "Седмица", settings: "Настройки", language: "Език",
